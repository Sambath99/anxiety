...
function addToCart() {
    ...
    const item = {
        ...
        quantity: quantity,
        price: price,
        image: './detail-image/hoodie/hoodie-007/007front.png', // Update with correct image path
        type: 'hoodie'
    };
...
async function fetchStockStatus() {
    try {
        ...
        const hoodieId = currentPage.includes('006') ? 'hoodie006' : 'hoodie007';
